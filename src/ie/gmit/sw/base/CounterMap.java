...
/**
 * An object that counts objects of type k. Store each object and the map them to a
 * integer count. Objects can be counted, his count retrieved, check if an object has been
 * counted and objects can be removed.
 * <p>
 * Each time a new element is counted it will be added to a set of all counted elements
 * and mapped to integer value, if the element is in the set the counted value will be
 * increased.
 * </p>
 * <p>
 * Used for count appearances of shingles. Then using 2 Counter Maps cosine distance can be
 * calculated.
 * 
...
public interface CounterMap<K> extends Identifiable
{
    ...
    /**
     * Increase the count of the object. If the object don't exist, add it to counted object
     * set and set his count to 1.
     * 
     * @param object to be counted
     * @return the old count of the object.
     * @throws ClassCastException   if the object is of an inappropriate type for this counter
    ...
    /**
     * Return true is the specified object have been counted, mean is in the set of counted
     * objects.
     * 
    ...
    /**
     * Remove an object from counter, after removed same object should return a count of 0.
     * 
     ...
     * 
     * @throws UnsupportedOperationException if map not support this operations
     */
    void clear();
